(function (global, factory) {
  ...
  */
  ...
  var colorDefs = [{
    re: /^rgba\(([0-9]{1,3}),[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*([0-9]{1,3}),[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*([0-9]{1,3}),[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*((?:[0-9]?\.)?[0-9])\)$/,
    example: ['rgba(123, 234, 45, 0.8)', 'rgba(255,234,245,1.0)'],
    process: function process(_, r, g, b, a) {
      return [parseInt(r), parseInt(g), parseInt(b), parseFloat(a)];
    }
  }, {
    re: /^rgb\(([0-9]{1,3}),[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*([0-9]{1,3}),[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*([0-9]{1,3})\)$/,
      ...
      colorDefs.forEach(function (_ref) {
        ...
        if (bits) {
          var _processor = processor(bits),
              _processor2 = _slicedToArray(_processor, 4),
              r = _processor2[0],
              g = _processor2[1],
              b = _processor2[2],
              alpha = _processor2[3];
  ...
  RGBColor.getHelpList = function () {
    ...
    list.append.apply(list, _toConsumableArray(examples.map(function (example) {
      try {
